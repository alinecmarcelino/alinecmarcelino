...
✅ Constribuir em projetos open source <br>
✅ Aplicar meus conhecimentos acadêmicas com prática profissional do dia-a-dia <br>
✅ Aprender com profissionais experientes e desenvolver softwares eficientes <br>
✅ Contribuir com minha visão única de transição de carreira <br>
✅ Crescer e evoluir como desenvolvedora <br>
✅ Trazer criatividade e dedicação para a equipe <br>
✅ Fazer parte de ambiente onde eu possa aprender, contribuir e crescer tecnicamente <br>
* **Disponibilidade:** Imediata <br> 
* **Carga Horária:** Flexível para acompanhar meus estudos EAD da faculdade <br>
* **Modalidade:** Presencial ou Híbrido (São Paulo e Região)/ Remoto (qualquer local)


> ### Por que TI e Programação? <br>
- Facilidade com lógica e resolução de problemas com ideias criativas
- Fascinio por evolução contínua e de como a tecnologia facilita isso
- Desejo de criar soluções que impactam pessoas e negócios


> ### Competências Transferíveis da Arquitetura para TI <br>
- Raciocínio lógico e analítico  
- Organização e planejamento de projetos  
- Leitura e interpretação de requisitos  
- Visão sistêmica e foco em solução  
- Disciplina com processos e prazos  
...
- **Tecnólogo em Análise e Desenvolvimento de Sistemas**
  ...
  - **Início:** 2025 [cursando 3º semestre]
  - **Previsão de conclusão:** Julho de 2027
  - **Disciplinas cursadas:** 
    - Pensamento Computacional, Algoritmos, Lógica Matemática, Estrutura de Dados;
    - Banco de Dados, Big Data e IoT, Sistemas Operacionas, Fundamentos de Redes;
    - Arquitetura e Organização de Computadores, Inteligência Emocional;

> ### Formação Anterior
- **Bacharelado em Arquitetura e Urbanismo**
  - Instituição: Universidade Santa Cecília [Santos/ SP]
  - **Conclusão:** 2012 - 2016
  - **Competências transferíveis:** 
    - Gestão de Projetos, Pensamento Analítico e Sistêmico;
    - Soluções de Problemas de forma Autêntica e Criativa;
...
- Estruturação de projetos e boas práticas iniciais
- Estudos de banco de dados e automação
<br>
...
| Tecnologias/ Ferramentas | Nível | Progresso |
|-----------|-------|-----------|
| Git/GitHub | Básico | ![Git](https://img.shields.io/badge/Progresso-70%25-F5B7B1) |
| VSCode | Básico | ![Python](https://img.shields.io/badge/Progresso-30%25-A8E6A3) |
| Python | Básico | ![Python](https://img.shields.io/badge/Progresso-10%25-A8E6A3) |
| SQL | Conceito | ![SQL](https://img.shields.io/badge/Progresso-10%25-A8E6A3) |
| HTML/CSS | >> Iniciar | ![HTML](https://img.shields.io/badge/Progresso-0%25-4479A1) |
| Java | >> Iniciar | ![Java](https://img.shields.io/badge/Progresso-0%25-4479A1) |
...
- [BOOTCAMP - Introdução à Experiência Santander 2015](https://hermes.dio.me/certificates/YR3OK4GA.pdf) | DIO | Santander | Julho 2025
    ...
    - [Conhecendo a Linguagem de Programação Python](https://hermes.dio.me/certificates/ERGKPGTN.pdf)
    - [Tipos de Operadores com Python](https://hermes.dio.me/certificates/5S9VZF7N.pdf)
    - [Estruturas Condicionais e de Repetição em Python](https://hermes.dio.me/certificates/L4JMJZOX.pdf)
    - [Versionamento de Código com Git e GitHub](https://hermes.dio.me/certificates/VD895RZ4.pdf)
<br>
<br>
